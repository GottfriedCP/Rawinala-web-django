"""
Django settings for rawinala_project project.
...
MIDDLEWARE = [
    ...
    'rawinala.middlewares.MessageCounterMiddleware',
]

ROOT_URLCONF = 'rawinala_project.urls'
...
WSGI_APPLICATION = 'rawinala_project.wsgi.application'
